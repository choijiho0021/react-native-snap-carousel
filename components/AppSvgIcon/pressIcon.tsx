...
const pressIcons: Record<string, React.ReactElement[]> = {
  ...
  micIcon: [
    <Svg
      ...
      />
      <Path
        d="M3.8 11.12c0 1.087.238 2.164.7 3.169a8.28 8.28 0 0 0 1.995 2.686 9.327 9.327 0 0 0 2.984 1.795c1.117.416 2.313.63 3.521.63m0 0c1.208 0 2.405-.214 3.52-.63a9.327 9.327 0 0 0 2.985-1.795 8.28 8.28 0 0 0 1.995-2.686c.462-1.005.7-2.082.7-3.169M13 19.4V24m0 0H7.48M13 24h5.52"
        stroke="#2266C5"
        strokeWidth="2"
        strokeLinecap="round"
      />
