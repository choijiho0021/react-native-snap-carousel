  ...
  keyCall: [
    <Svg width="36" height="36" viewBox="0 0 36 36">
      <G fill="none" fillRule="evenodd" transform="translate(3 3)">
        <Mask id="fgg4khrryb" fill="#fff">
          <Path id="ckdfvlydoa" d="M0 0L30 0 30 30 0 30z" />
        </Mask>
        <Path
          fill="#FFF"
          d="M20.991 17.347l-3.58 3.583c-3.47-1.98-6.35-4.865-8.332-8.333l3.58-3.583c1.027-1.027 1.027-2.693 0-3.72L8.14.77C7.112-.257 5.45-.257 4.421.77L1.613 3.58l-.834.834c-.594.595-.888 1.443-.742 2.27.192 1.1.444 2.178.762 3.228 2.784 9.207 10.038 16.446 19.237 19.245 1.072.326 2.167.599 3.285.804.831.152 1.685-.145 2.282-.742l1.52-1.52 2.106-2.11c1.028-1.026 1.028-2.692.001-3.72l-4.52-4.522c-1.028-1.027-2.692-1.027-3.719 0"
          mask="url(#fgg4khrryb)"
        />
      </G>
    </Svg>,
  ...
  keyDel: [
    <Svg width="42" height="29" viewBox="0 0 42 29">
      <G fill="none" fill-rule="evenodd">
        <Mask id="8sx3th49kb" fill="#fff">
          <Path id="sv4hpbwnka" d="M0 0L42 0 42 29 0 29z" />
        </Mask>
        <Path
          fill="#D8D8D8"
          d="M39.007 0H15.1c-.666 0-1.313.231-1.838.655L1.155 12.046c-1.54 1.245-1.54 3.663 0 4.908l12.108 11.391c.525.424 1.172.655 1.838.655h23.906C40.66 29 42 27.608 42 25.892V3.108C42 1.392 40.66 0 39.007 0m0 1C40.106 1 41 1.931 41 3.078v22.844C41 27.068 40.106 28 39.007 28H15.101c-.43 0-.853-.147-1.197-.415L1.828 16.19l-.057-.05C1.281 15.744 1 15.147 1 14.5s.281-1.244.771-1.64l.057-.05L13.904 1.414c.344-.268.767-.415 1.197-.415h23.906"
          mask="url(#8sx3th49kb)"
        />
        <G transform="translate(19 7)">
          <Mask id="fi4t4utmmd" fill="#fff">
            <Path id="5tvaxyaxtc" d="M0 0L15 0 15 15 0 15z" />
          </Mask>
          <Path
            fill="#2C2C2C"
            d="M8.94 7.5l5.763-5.762c.396-.397.396-1.045 0-1.44-.395-.397-1.044-.397-1.44 0L7.5 6.057 1.738.299C1.34-.1.693-.1.298.297-.1.692-.1 1.34.297 1.737L6.06 7.5.297 13.262c-.396.396-.396 1.045 0 1.44.396.397 1.044.397 1.44 0L7.5 8.94l5.762 5.763c.397.396 1.046.396 1.44 0 .397-.396.397-1.045 0-1.44L8.94 7.5z"
            mask="url(#fi4t4utmmd)"
          />
        </G>
      </G>
