...
const pressIcons: Record<string, React.ReactElement[]> = {
  ...
  keyNation: [
    <Svg
      ...
      <Path
        d="M46.692 34c0 7.01-5.682 12.693-12.692 12.693m12.692-12.692c0-7.01-5.682-12.692-12.692-12.692M46.692 34H21.308M34 46.693c-7.01 0-12.692-5.682-12.692-12.692M34 46.693V21.31m0 25.384s-6.923-5.769-6.923-12.692S34 21.309 34 21.309m0 25.384s6.923-5.769 6.923-12.692S34 21.309 34 21.309M21.308 34c0-7.01 5.682-12.692 12.692-12.692m-9.791 4.615s4.599 2.308 9.791 2.308 9.791-2.308 9.791-2.308M24.21 42.078S28.808 39.77 34 39.77s9.791 2.308 9.791 2.308"
        stroke="#2C2C2C"
        stroke-width="2"
      />
    </Svg>,
    <Svg
      ...
      <Path
        d="M46.692 34c0 7.01-5.682 12.693-12.692 12.693m12.692-12.692c0-7.01-5.682-12.692-12.692-12.692M46.692 34H21.308M34 46.693c-7.01 0-12.692-5.682-12.692-12.692M34 46.693V21.31m0 25.384s-6.923-5.769-6.923-12.692S34 21.309 34 21.309m0 25.384s6.923-5.769 6.923-12.692S34 21.309 34 21.309M21.308 34c0-7.01 5.682-12.692 12.692-12.692m-9.791 4.615s4.599 2.308 9.79 2.308c5.193 0 9.792-2.308 9.792-2.308M24.21 42.078s4.599-2.308 9.79-2.308c5.193 0 9.792 2.308 9.792 2.308"
        stroke="#2C2C2C"
        stroke-width="2"
      />
    </Svg>,
  ...
  keyHangup: [
    <Svg width="36" height="36">
      <G transform="rotate(135 15.795 18.211)" fill="none" fill-rule="evenodd">
        <Mask id="b" fill="#fff">
          <Path id="a" d="M-.207.793h30v30h-30z" />
        </Mask>
        <Path
          d="m20.784 18.14-3.58 3.583a22.383 22.383 0 0 1-8.332-8.333l3.58-3.583a2.63 2.63 0 0 0 0-3.72l-4.52-4.523a2.627 2.627 0 0 0-3.718 0L1.406 4.373l-.834.834c-.594.595-.888 1.443-.742 2.27.192 1.1.444 2.178.762 3.228C3.376 19.912 10.63 27.15 19.829 29.95c1.072.326 2.167.599 3.285.804.83.152 1.685-.145 2.282-.742l1.52-1.52 2.106-2.11a2.63 2.63 0 0 0 0-3.72l-4.52-4.522a2.63 2.63 0 0 0-3.718 0"
          fill="#FFF"
          mask="url(#b)"
        />
      </G>
  ...
  keypad: [
    <Svg width="36" height="36">
      <G fill="none" fill-rule="evenodd">
        <Path
          d="M10 7a3 3 0 1 0 0 6 3 3 0 0 0 0-6m0 2a1.001 1.001 0 0 1 0 2 1.001 1.001 0 0 1 0-2M18 7a3 3 0 1 0 0 6 3 3 0 0 0 0-6m0 2a1.001 1.001 0 0 1 0 2 1.001 1.001 0 0 1 0-2"
          fill="#2C2C2C"
        />
        <G transform="translate(23 7)">
          ...
          <Path
            d="M3 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6m0 2a1.001 1.001 0 0 1 0 2 1.001 1.001 0 0 1 0-2"
            fill="#2C2C2C"
            mask="url(#b)"
          />
        </G>
        <Path
          d="M10 15a3 3 0 1 0 0 6 3 3 0 0 0 0-6m0 2a1.001 1.001 0 0 1 0 2 1.001 1.001 0 0 1 0-2M18 15a3 3 0 1 0 0 6 3 3 0 0 0 0-6m0 2a1.001 1.001 0 0 1 0 2 1.001 1.001 0 0 1 0-2"
          fill="#2C2C2C"
        />
        ...
        <Path
          d="M10 23a3 3 0 1 0 0 6 3 3 0 0 0 0-6m0 2a1.001 1.001 0 0 1 0 2 1.001 1.001 0 0 1 0-2M18 23a3 3 0 1 0 0 6 3 3 0 0 0 0-6m0 2a1.001 1.001 0 0 1 0 2 1.001 1.001 0 0 1 0-2"
          fill="#2C2C2C"
        />
    ...
    <Svg width="36" height="36">
      <G fill="none" fill-rule="evenodd">
        <G transform="translate(5 7)">
          <Mask id="b" fill="#fff">
            <Path id="a" d="M0 0h19v22H0z" />
          </Mask>
          <Path
            d="M14.519.399 5 5.999H2c-.825 0-2 1.014-2 1.839v6C0 14.664 1.175 16 2 16h3l9.518 5.6A2.97 2.97 0 0 0 16 22c1.564 0 3-1.575 3-3.323V3c0-1.748-1.435-3-2.999-3a2.97 2.97 0 0 0-1.482.399zM17 3v16c0 .618-.52 1-1 1a.98.98 0 0 1-.464-.121L6 13.999H2V8h4l9.537-5.878A.977.977 0 0 1 16.001 2c.48 0 .999.382.999 1z"
            fill="#2C2C2C"
            mask="url(#b)"
          />
        </G>
        <G transform="translate(26 13)">
          <Mask id="d" fill="#fff">
            <Path id="c" d="M0 0h5v10H0z" />
          </Mask>
          <Path
            d="M1 10a1 1 0 0 1-.311-1.95C2.071 7.596 3 6.371 3 5 3 3.629 2.071 2.404.689 1.952a1 1 0 0 1 .622-1.9C3.518.771 5 2.76 5 5 5 7.239 3.518 9.228 1.311 9.95A.991.991 0 0 1 1 10"
            fill="#2C2C2C"
            mask="url(#d)"
          />
        </G>
