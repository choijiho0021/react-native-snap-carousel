...
const en = {
  ...
  "pym:home": "In front of the house.",
  "pym:toHome": "Please put it in front of the house.",
  ...
  "pym:privacy": "Collection and use of personal information (essential)",
  "pym:paymentAgency": "Terms of use of payment agency service (essential)",
...
const ko = {
  ...
  "pym:privacy": "개인정보 수집 및 이용 (필수)",
  "pym:paymentAgency": "결제대행 서비스 이용약관 (필수)",
  "pym:detail": "자세히 보기",
