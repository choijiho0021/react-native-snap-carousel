...
class AddProfileScreen extends Component {
  ...
  componentDidMount() {
    const update = (this.props.route.params || {}).update;
            ...
            <View style={{margin: 20, flex: 1}}>
              <View style={styles.textRow}>
                ...
                <TextInput
                  style={[
                    styles.textBox,
                    {borderColor: this._changeBorder('alias')},
                  ]}
              ...
              <View style={styles.textRow}>
                ...
                <TextInput
                  style={[
                    styles.textBox,
                    {borderColor: this._changeBorder('recipient')},
                  ]}
                ...
                <View style={[styles.textWidth, {flexDirection: 'row'}]}>
                  ...
                  <TextInput
                    style={[
                      styles.textBox,
                      {
                        borderColor: this._changeBorder('recipientNumber'),
                        width: '65%',
                      },
                    ]} // 56%
                ...
                <View style={[styles.textWidth, {flexDirection: 'row'}]}>
                  <Text
                    style={[
                      styles.textBox,
                      {
                        borderColor: this._changeBorder('addressLine1'),
                        width: '76%',
                        paddingVertical: 10,
                      },
                    ]}
              ...
              <View style={[styles.findTextRow, {marginBottom: 13}]}>
                <TextInput
                  style={[
                    styles.textBox,
                    {borderColor: this._changeBorder('detailAddr')},
                  ]}
